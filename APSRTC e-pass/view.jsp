...
<center><br><br><br><table align="center"  bordercolor="blue"><%
while(rs.next())
{
%>

      <tr>
        <td><%=rs.getString("date")%>&nbsp&nbsp&nbsp&nbsp</td><td><%=rs.getString("name")%></td>&nbsp&nbsp&nbsp&nbsp<td><%=rs.getString("message")%></td><br>       
      </tr>
	 <%
}
%> </table></center><%
