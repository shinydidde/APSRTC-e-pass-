...
int stat=st.executeUpdate("insert into comp(date,message) values('"+dt+"','"+ msg+"')");
if(stat>0)
{
%><center><br><br><br><b><%out.print("Complaint Posted");%></b></center><br><br><br><center><a href="userlog.jsp">Go Back</a></center><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
...
{
%><center><br><br><br><%out.print(""+e);%></center>

<center><a href="comp1.jsp">Try Again</a></ceneter><%
}%>
