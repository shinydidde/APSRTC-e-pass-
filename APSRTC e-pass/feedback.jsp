...
var first1 = document.myForm.fname.value;
var first = document.myForm.ano.value;

count=0;
if(first1==null || first1=="") 
         {
           document.getElementById("first_error").innerHTML="Enter Your  Name";
       count++;
        }
if(first==null || first=="") 
         {
...
<body text="#666633" bgcolor="#cccc99">
  <br><center><img src="feedback.gif" alt="Feedback" /></center>
    <p class="text"><center>Help us Know About Our Service.</center> </p>

<form   action="fb1.jsp" method="post" name="myForm" onsubmit="return validate()">
<center>
...
<tr>
    <center>
	<tr>
   <td><label class="txt1"> Name:<label></td>
   <td><input type='text' name='fname'></td>
      <td width="200px"><span id="first_error" class="error">&nbsp;</span></td>
</tr>
         <tr>
   <td><label class="txt1">Comment:<label></td>
